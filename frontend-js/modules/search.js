...
export default class Search {
  ...
  keyPressHandler() {
    ...
    if (value != "" && value != this.previousValue) {
      clearTimeout(this.typingWaitTimer); // if a new keystroke is done the timer will be reset
      this.showLoaderIcon();
  ...
  openOverlay() {
    ...
    setTimeout(() => this.inputField.focus(), 50); // places user cursor in this field
  }
